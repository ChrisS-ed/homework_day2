...
puts "The volume of a cube with a length of 3 is #{cube_volume}"
sphere_volume = calculate_sphere_volume(3)
puts "The volume of a sphere with a radius of 3 is #{sphere_volume}"
...
nights_to_xmas_result = nights_to_xmas
